...
uvb_dnb = ESSN_node[(ESSN_node['node_type1'] == 'mDNB1') & (ESSN_node['node_type2'] != 'plain')].index
# uvb_dnb = ESSN_node[(ESSN_node['node_type1'] == 'mDNB1')].index
...
# visit 7 SBT group
idx = (L_df.loc[:, 'Test_regimes'] == 'DEG') & (L_df.loc[:, 'Product'] == 'A') & (L_df.loc[:, 'Visit'] == 7)
visit7_L = L_df.loc[idx, 'CFB']

# visit 8 SBT group
idx = (L_df.loc[:, 'Test_regimes'] == 'Phenotype') & (L_df.loc[:, 'Product'] == 'A') & (L_df.loc[:, 'Visit'] == 8)
visit8_L = L_df.loc[idx, 'CFB']

# visit 9 SBT group
idx = (L_df.loc[:, 'Test_regimes'] == 'Phenotype') & (L_df.loc[:, 'Product'] == 'A') & (L_df.loc[:, 'Visit'] == 9)
visit9_L = L_df.loc[idx, 'CFB']

# visit 10 SBT group
idx = (L_df.loc[:, 'Test_regimes'] == 'Phenotype') & (L_df.loc[:, 'Product'] == 'A') & (L_df.loc[:, 'Visit'] == 10)
...
print(p_values)
p_values.to_excel('P_value L mDNB1 strict.xlsx')
