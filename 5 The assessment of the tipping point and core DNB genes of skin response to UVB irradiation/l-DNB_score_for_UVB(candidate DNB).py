...
if __name__ == "__main__":
    ...
    uvb_dnb = key_dnb[(key_dnb['node_type1'] == 'mDNB1') & (key_dnb['node_type2'] != 'plain')].index
    print('mDNB1 strict num:', len(uvb_dnb))
    ...
    L_DNB_score.to_excel('L-DNB_score_UVB(alt-dnb strict).xlsx')
    ...
    L_DNB_result.to_excel('L_DNB_result_UVB(alt-dnb strict).xlsx')
